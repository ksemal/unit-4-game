  ...
  $(".allCharacter")
    ...
    .on("click", function() {
      ...
      $(".character").each(function() {
        restOfCharacters += $(this)
          .appendTo("#enemies")
          .css("border-color", "rgb(207, 43, 2)");
      });
      $(this)
        .appendTo("#your_character")
        .css("border-color", "aquamarine");
      ...
      $("#enemies")
        ...
        .on("click", function chooseEnemy() {
          ...
          playerAttackPower =
            playerAttackPower + characterCollection[idPlayer].attackPower;
          $(this)
            .appendTo("#defender")
          ...
          $("#startFight").on("click", function fight() {
            playerHealthPoints =
              playerHealthPoints -
              characterCollection[idEnemy].counterAttackPower;
            ...
            if (playerHealthPoints > 0 && enemyHealthPoints > 0) {
              $("#result").html(
                "You attacked " +
                  characterCollection[idEnemy].name +
                  " for " +
                  playerAttackPower +
                  " damage. " +
                  characterCollection[idEnemy].name +
